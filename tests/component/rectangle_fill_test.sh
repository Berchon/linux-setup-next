...
assert_eq "$(cell_buffer_get_cell back 1 1)" "┌|2|5|1" "single border should draw continuous top-left corner in unicode mode"
assert_eq "$(cell_buffer_get_cell back 3 1)" "─|2|5|1" "single border should draw continuous horizontal edge in unicode mode"
assert_eq "$(cell_buffer_get_cell back 1 2)" "│|2|5|1" "single border should draw continuous vertical edge in unicode mode"
...
assert_eq "$(cell_buffer_get_cell back 1 2)" "║|2|5|1" "double border should use continuous vertical edge in unicode mode"
...
assert_eq "$(cell_buffer_get_cell back 8 1)" "┐|6|1|1" "title clipping should preserve top-right corner in unicode mode"
